...
public partial class Sites : System.Web.UI.Page {
    protected void Page_Load(object sender, EventArgs e) {
        ...
        if (hd3.siteDetect()) {
            ...
            Response.Write("Vendor " + ((IDictionary)reply["hd_specs"])["general_vendor"] + "<br/>");
            Response.Write("Model " + ((IDictionary)reply["hd_specs"])["general_model"] + "<br/>");
            Response.Write("Browser " + ((IDictionary)reply["hd_specs"])["general_browser"] + "<br/>");
            Response.Write("Platform " + ((IDictionary)reply["hd_specs"])["general_platform"] + "<br/>");
            Response.Write(hd3.getLog());
        } else {
            Response.Write(hd3.getError() + "<br/>");
            Response.Write(hd3.getLog());
